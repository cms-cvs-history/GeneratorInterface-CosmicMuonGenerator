...
public :
 ...
 //crsIO::TShower  *shower.;
   ...
   UChar_t         particle__ParticleID[kMaxparticle_];   //[particle._]
   UChar_t         particle__ObservationLevel[kMaxparticle_];   //[particle._]
   UChar_t         particle__HadronicGeneration[kMaxparticle_];   //[particle._]
   Float_t         particle__Px[kMaxparticle_];   //[particle._]
   Float_t         particle__Py[kMaxparticle_];   //[particle._]
   Float_t         particle__Pz[kMaxparticle_];   //[particle._]
   Float_t         particle__x[kMaxparticle_];   //[particle._]
   Float_t         particle__y[kMaxparticle_];   //[particle._]
   Float_t         particle__Time[kMaxparticle_];   //[particle._]
   Float_t         particle__Weight[kMaxparticle_];   //[particle._]
   Int_t           long_;
